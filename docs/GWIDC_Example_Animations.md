...
![Example of FLASH mode in Green](images/FLASH_animation.gif)

### Example of PULSE mode in Red
`http://<GWIDC_IPAddress>/?PULSE&RGB=FF0000` 
![Example of PULSE mode in Red](images/PULSE_animation.gif)

### Example of SOS mode in Red
`http://<GWIDC_IPAddress>/?STROBE&RGB=FF0000` 
![Example of SOS mode in Blue](images/SOS_animation.gif)

### Example of STROBE mode in Blue
`http://<GWIDC_IPAddress>/?STROBE&RGB=0000FF` 
![Example of STROBE mode in Blue](images/STROBE_animation.gif)


### Example of TRAIL mode in Yellow
`http://<GWIDC_IPAddress>/?TRAIL&RGB=FFFF00` 
![Example of TRAIL mode in Yellow](images/TRAIL_animation.gif)
