...
hubitat/       → Hubitat device driver and Hubitat-specific docs  
hardware/      → Schematics 
...
|Hubitat Device Driver (Groovy)|`hubitat/drivers/`|	MIT|
